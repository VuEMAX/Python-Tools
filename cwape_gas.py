...
def insert_data():
    ...
    for postcode in postcodes:
        try:
            dgo_url=f'https://www.compacwape.be/rest/util/dgo?typeEnergy=gas&zipCode={postcode}'
            ...
            if dgo_res.json():
                ...
                df.loc[(df['type'] == 'fixed') & (df['duration'] == '1')].head(10).to_sql('gas_offer', con=engine, if_exists='append', index=False)
